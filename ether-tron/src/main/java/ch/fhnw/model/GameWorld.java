...
public class GameWorld {
	...
	// private ILight light = new PointLight(new Vec3(0, 0, 20), AMBIENT, COLOR,
	// 10);
	...
	// private ILight light = new SpotLight(Vec3.Z, AMBIENT, COLOR, Vec3.Z, 0,
	// 0);
	...
	private void updateCamera(Vec3 position, Vec3 direction, float rot) {
		// Vec3 camara_position = new Vec3(playerPosition.x, playerPosition.y -
		// 6, playerPosition.z
		// + 2);
		Vec3 pos;
		if (rot > 0) {
